...
class PaoPao(BaseFeedBook):
	...
	keep_only_tags = [dict(name='div', attrs={'class':'ds-1col node node-pao-pao-article node-full view-mode-full clearfix '})]
	remove_tags = []
	remove_ids = []
	remove_classes = []
	remove_attrs = []
	...
	feeds = [
	(u'泡泡网','https://s3.amazonaws.com/pao-pao/articles.html'),
	]
